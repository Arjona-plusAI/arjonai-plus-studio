...
const InstallManager = (function () {
    ...
    function createInstallBanner() {
        ...
        if (platform.isIOS) {
            ...
            subtitle.textContent =
                'Install as app — No Play Store needed!';
        } else if (platform.isWindows || platform.isMac) {
            subtitle.textContent =
                'Install as desktop app — Works offline!';
        } else {
            subtitle.textContent =
    ...
    function showIOSGuide() {
        ...
        box.innerHTML = `
            ...
            <div style="font-size:13px;color:var(--tx2);
                ...
                Follow these steps to install Arjona AI Studio 
                on your home screen:
            </div>
            ...
            <div style="display:flex;flex-direction:column;
                ...
                <div style="display:flex;align-items:center;gap:12px;
                    background:var(--sf2);padding:12px;
                    border-radius:12px">
                    <div style="font-size:24px">1️⃣</div>
                    <div>
                        <div style="font-size:12px;font-weight:700;
                            color:var(--tx)">Tap Share Button</div>
                        <div style="font-size:11px;color:var(--tx2)">
                            Bottom toolbar me Share 
                            <b>⬆</b> icon tap karo
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex;align-items:center;gap:12px;
                    ...
                    <div>
                        ...
                        <div style="font-size:11px;color:var(--tx2)">
                            Scroll down aur 
                            <b>"Add to Home Screen"</b> tap karo
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex;align-items:center;gap:12px;
                    ...
                    <div>
                        <div style="font-size:12px;font-weight:700;
                            color:var(--tx)">Tap Add</div>
                        <div style="font-size:11px;color:var(--tx2)">
                            Top right me <b>"Add"</b> tap karo
                        </div>
                    </div>
                </div>
            </div>
    ...
    /* ===== INSTALL GUIDE (for browsers without prompt) ===== */
    function showInstallGuide(platform) {
        ...
        if (platform.isChrome && !platform.isMobile) {
            steps = `
                <div class="ig-step">
                    <span>1️⃣</span>
                    <span>Address bar ke end me 
                    <b>Install icon ⊕</b> click karo</span>
                </div>
                <div class="ig-step">
                    <span>2️⃣</span>
                    <span><b>"Install"</b> button click karo</span>
                </div>
                <div class="ig-step">
                    <span>3️⃣</span>
                    <span>Desktop pe app appear hogi! ✅</span>
                </div>
            `;
            ...
            steps = `
                <div class="ig-step">
                    <span>1️⃣</span>
                    <span>Address bar me 
                    <b>house icon 🏠</b> click karo</span>
                </div>
                <div class="ig-step">
                    <span>2️⃣</span>
                    <span><b>"Add to Home Screen"</b> select karo</span>
                </div>
            `;
        } else {
            steps = `
                <div class="ig-step">
                    <span>ℹ️</span>
                    <span>Chrome browser use karo 
                    best install experience ke liye!</span>
                </div>
            `;
        }
        ...
        if (window.toast) {
            window.toast(
                'Chrome address bar me Install icon click karo!',
                'info', 5000
            );
        }
    }
    ...
    function showInstallSuccess() {
        ...
        box.innerHTML = `
            ...
            <div style="font-size:13px;color:var(--tx2);
                ...
                Arjona AI Studio ab tumhare device pe 
                install ho gayi hai!<br>
        ...
        setTimeout(() => {
            if (window.PhysicsEngine &&
                window.PhysicsEngine.Particles) {
                PhysicsEngine.Particles.confetti(
                    window.innerWidth / 2,
    ...
    function createDownloadPage() {
        /* Add download/install button to website */
